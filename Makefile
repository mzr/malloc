...
test-spec: tests/spec_tests.c malloc.o malloc.h
	$(CC) $(CFLAGS) -g  tests/spec_tests.c malloc.o -o ./tests/test-spec

test-cases: tests/test_cases.c malloc.o malloc.h
	$(CC) $(CFLAGS) -g tests/test_cases.c malloc.o -o ./tests/test-cases

test-functional: tests/functional_test.c malloc.o integrity-check.o malloc.h
	$(CC) -std=gnu11 -g tests/functional_test.c malloc.o integrity-check.o -o ./tests/functional-test
